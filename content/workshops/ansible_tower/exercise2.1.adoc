...
Select CREDENTIALS image:at_credentials.png[credentials,150,50]

=== Step 3:

Click on *+*     image:at_add.png[Add,35,25]
...
Click on PROJECTS image:at_projects.png[projects,150,50]
...
Click on INVENTORIES image:at_inventories.png[inventories,150,50]
...
From the drop down, select *Inventory*
image:at_inventory.png[inventory,200]
...
Feel free to browse your inventory in Tower by selecting *HOSTS*.  
image:at_inv_hosts.png[hosts,200,50]

You should now notice that the inventory has been populated with each
each of hosts and corresponding inventory
