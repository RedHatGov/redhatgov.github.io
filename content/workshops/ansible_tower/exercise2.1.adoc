...
However, we are only going to focus on the key contructs that are required for this workshop today.
...
Feel free to browse your inventory in Ansible Tower.  You should now notice that the inventory has been populated with Groups and that
