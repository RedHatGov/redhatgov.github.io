...
[source,bash]
----
ansible-playbook --private-key=~/.ssh/workshop-tower -i ../hosts install_apache.yml
----
...
[source,bash]
----
ansible-playbook --private-key=~/.ssh/workshop-tower -i ../hosts install_apache.yml --syntax-check
----
