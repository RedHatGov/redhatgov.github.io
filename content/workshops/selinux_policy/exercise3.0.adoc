...
In your wetty window (if you closed it, see the link:/workshops/selinux_policy/setup/[SETUP] step, in your workbook), type the following:
...
- downloading role from https://github.com/RedHatOfficial/ansible-rhel7-disa-stig-role/archive/0.1.41.t
ar.gz
