---
title: "Exercise 1.1 - Creating and Running a Job Template"
...
image::at_jt_detail.png[caption="Figure 11: ",700,title="Job Template Form"]
...
image::at_job_stdout.png[caption="Figure 15: ",700,title="Job Standard Output"]
...
image::at_web_tm.png[caption="Figure 16: ",700,title="New Website with Personalized Test Message"]
