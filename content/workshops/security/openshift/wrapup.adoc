...
:imagesdir: /workshops/security/openshift/images

= Wrap Up and Q&A

That wraps up what we have planned for today.  We hope you've learned something valuable +
about OpenShift Security that you can apply in your daily role.
...
find a ton of links that will further your OpenShift education.

This *Participant Guide* will remain active for the next two weeks.  Please take advantage +
of it by creating your own OpenShift Security environment back at your organization.
